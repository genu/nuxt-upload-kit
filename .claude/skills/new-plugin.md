...
2. Based on the plugin type, create the file in the appropriate location:
   - Validators: `src/runtime/composables/useUploadManager/validators/`
   - Processing: `src/runtime/composables/useUploadManager/plugins/`
   - Storage: `src/runtime/composables/useUploadManager/plugins/storage/`
...
4. Export the new plugin from `src/runtime/composables/useUploadManager/plugins/index.ts`
