...
const uploader = useUploadManager({
  storage: PluginAzureDataLake({
    sasURL: 'https://mystorageaccount.blob.core.windows.net/mycontainer?sv=2022-11-02&ss=b&srt=co&sp=rwdlaciytfx&se=2024-12-31T23:59:59Z&st=2024-01-01T00:00:00Z&spr=https&sig=...',
    path: 'uploads/images'
  })
})
```
...
await uploader.initializeExistingFiles([
  { id: 'path/to/file1.jpg' },
  { id: 'path/to/file2.png' }
])
```
