...
| Provider             | Adapter                  | Auth Method      | Status       |
| -------------------- | ------------------------ | ---------------- | ------------ |
| Azure Data Lake      | `PluginAzureDataLake`    | SAS URL          | Available    |
| AWS S3               | `PluginAWSS3`            | Presigned URLs   | Experimental |
| Cloudflare R2        | `PluginCloudflareR2`     | Presigned URLs   | Experimental |
| Firebase Storage     | `PluginFirebaseStorage`  | Firebase SDK     | Experimental |
...
```ts
import { PluginAWSS3 } from "nuxt-upload-kit"
